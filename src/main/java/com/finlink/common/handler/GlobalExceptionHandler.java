 ...
 *     <li><b>标准响应格式</b>：所有异常都转换为 {@link com.finlink.common.domain.Result} 格式</li>
 ...
 *
 * @author 稚名不带撇
 * @see com.finlink.common.domain.Result
 * @see com.finlink.common.domain.ResultCode
 * @see com.finlink.common.exception.ServiceException
 */
@Slf4j
...
public class GlobalExceptionHandler {
     ...
     *     <li>错误码：{@link com.finlink.common.domain.ResultCode#REQUEST_METHOD_NOT_SUPPORTED}</li>
     ...
     * @see com.finlink.common.domain.ResultCode#REQUEST_METHOD_NOT_SUPPORTED
     */
     ...
     *     <li>错误码：{@link com.finlink.common.domain.ResultCode#PARA_TYPE_MISMATCH}</li>
     ...
     * @see com.finlink.common.domain.ResultCode#PARA_TYPE_MISMATCH
     */
     ...
     * <ul>
     *     <li>HTTP 状态码设置为 400（Bad Request）</li>
     *     <li>错误码：{@link com.finlink.common.domain.ResultCode#INVALID_PARA}</li>
     ...
     * @see com.finlink.common.domain.ResultCode#INVALID_PARA
     */
     ...
     *     <li>错误码：{@link com.finlink.common.domain.ResultCode#ERROR}</li>
     ...
     * @see com.finlink.common.domain.ResultCode#ERROR
     */
